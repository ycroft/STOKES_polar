	...
	def __init__(self, globalConfig):
		'''
			config :
				...
				==rdata		NOT NULL
		'''
		self.NS = globalConfig.get('ns',1024)
		self.D1 = globalConfig.get('d1',1.9)
		self.D2 = globalConfig.get('d2',3.8)
		self.autofix = globalConfig.get('autofix',True)
		self.frequency = globalConfig.get('frequency','high')
		self.workpath = globalConfig.get('workpath','./spec_data')
		self.sdataName = globalConfig.get('sdata','')
		self.rdataName = globalConfig.get('rdata','')
		...
		self.sdataPath = self.workpath + self.sdataName + '.sd'
		self.idataPath = self.workpath + self.sdataName + '.id'
		self.rdataPath = self.workpath + self.rdataName + '.rd'
